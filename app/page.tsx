...
function TestimonialCard({ name, text, title, rating }: { name: string; text: string; title?: string; rating?: number }) {
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
      ...
      <p className="text-gray-600 mb-4 italic leading-relaxed">"{text}"</p>
  ...
  if (submitted) {
    return (
      <div className="bg-green-50 border border-green-200 rounded-lg p-8 text-center">
        ...
        <p className="text-green-600">{t('contact.form.success.description')}</p>
        <button 
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          >
            ...
            <option value="cleaning">{t('contact.form.services.cleaning')}</option>
            <option value="implants">{t('contact.form.services.implants')}</option>
            <option value="cosmetic">{t('contact.form.services.cosmetic')}</option>
            <option value="emergency">{t('contact.form.services.emergency')}</option>
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-black to-black py-20 overflow-hidden h-[70vh] max-lg:h-[calc(100vh-64px)] flex items-center">
        {/* Background Image */}
        ...
        <div className="container mx-auto px-4 text-center relative z-20">
          <h1 className="text-5xl font-bold text-gray-100 mb-6">
            {t('hero.title')} <span className="text-amber-500">Golden Smile</span>
          </h1>
             ...
             <div>
              ...
              <div className="grid gap-4 mb-8">
                <div className="bg-white p-6 rounded-lg shadow-md flex items-center">
                  ...
                  <div>
                     <h4 className="font-semibold text-gray-800">{t('contact.info.phone.label')}</h4>
                 ...
                 <div className="bg-white p-6 rounded-lg shadow-md flex items-center">
                   ...
                   <div>
                     <h4 className="font-semibold text-gray-800">{t('contact.info.email.label')}</h4>
                 ...
                 <div className="bg-white p-6 rounded-lg shadow-md flex items-center">
                   ...
                   <div>
                     <h4 className="font-semibold text-gray-800">{t('contact.info.address.label')}</h4>
              ...
              <div className="bg-white rounded-lg shadow-md overflow-hidden">
                <div className="bg-gray-200 h-64 flex items-center justify-center relative">
                  <div className="text-center">
                     ...
                     <p className="text-gray-500 font-medium">{t('contact.info.map.title')}</p>
                     <p className="text-sm text-gray-400">{t('contact.info.map.clinic')}</p>
                   </div>
                ...
                <div className="p-4">
                  <div className="flex justify-between items-center">
                     <div>
                       <h4 className="font-semibold text-gray-800">{t('contact.info.map.clinic')}</h4>
                       <p className="text-sm text-gray-600">{t('contact.info.address.street')}, {t('contact.info.address.city')}</p>
                     </div>
                     <a 
