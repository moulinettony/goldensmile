      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 mt-2 text-sm">{t('footer.tagline')}</p>
          </div>
          
          <div>
            <h4 className="font-semibold tracking-wider uppercase text-gray-300">{t('footer.quickLinks')}</h4>
            <ul className="mt-4 space-y-2 text-gray-400">
              <li><a href="#services" className="hover:text-white transition-colors">{t('navigation.services')}</a></li>
          ...
          <div>
            <h4 className="font-semibold tracking-wider uppercase text-gray-300">{t('footer.contactInfo')}</h4>
            <ul className="mt-4 space-y-2 text-gray-400">
          ...
          <div>
            <h4 className="font-semibold tracking-wider uppercase text-gray-300">{t('footer.followUs')}</h4>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400 text-sm">
          <p>© {new Date().getFullYear()} Golden Smile. {t('footer.copyright')}</p>
        </div>
      </div>
    </footer>
  );
