      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 mt-2 text-sm">Façonner votre sourire doré parfait.</p>
          </div>
          
          <div>
            <h4 className="font-semibold tracking-wider uppercase text-gray-300">Liens Rapides</h4>
          ...
          <div>
            <h4 className="font-semibold tracking-wider uppercase text-gray-300">Coordonnées</h4>
            <ul className="mt-4 space-y-2 text-gray-400">
              <li className="flex items-start">
                <span className="mt-1 mr-2"></span> 
                <span>123 Avenue Dentaire, Cité du Sourire, ST 12345</span>
              </li>
          ...
          <div>
            <h4 className="font-semibold tracking-wider uppercase text-gray-300">Suivez-nous</h4>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400 text-sm">
          <p>© {new Date().getFullYear()} Golden Smile. Tous Droits Réservés.</p>
        </div>
      </div>
    </footer>
  );
