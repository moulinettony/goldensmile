...
'use client'; // Still needed for the mobile menu toggle
      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <a href="#testimonials" className="text-gray-600 hover:text-amber-500 transition-colors">Témoignages</a>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white py-4">
          <nav className="flex flex-col items-center space-y-4">
            <a href="#services" onClick={() => setIsMenuOpen(false)} className="text-gray-600 hover:text-amber-500">Services</a>
            <a href="#about" onClick={() => setIsMenuOpen(false)} className="text-gray-600 hover:text-amber-500">À Propos</a>
            <a href="#testimonials" onClick={() => setIsMenuOpen(false)} className="text-gray-600 hover:text-amber-500">Témoignages</a>
            <a href="#contact" onClick={() => setIsMenuOpen(false)} className="text-gray-600 hover:text-amber-500">Contact</a>
